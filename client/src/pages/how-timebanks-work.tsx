    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pt-16">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-8">
                The fundamental principle of TimeBanking is that <span className="font-bold text-[#8FC24C]">everyone's time is valued equally</span>. 
                One hour of service rendered earns one TimeDollar (TD), irrespective of the type of service provided. 
                At EMC HUB, <span className="font-bold">1 TD = HK$60</span>.
              </p>
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-gray-700">Services can vary widely—tutoring, home repairs, cooking, transportation, and more</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#8FC24C] flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">Focus on skills and support that individuals can offer within the community</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#8FC24C] flex-shrink-0 mt-0.5" />
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-4">
              The 5 Core Values of TimeBanking
            </h2>
              ...
              <Card className="border-l-4 border-l-[#8FC24C]">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">Everyone of us has something of value to share with someone else. Your skills, knowledge, and time are valuable assets that can benefit your community.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#8FC24C]">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">There are some forms of work that money will not easily pay for—like building strong families, revitalizing neighborhoods, and advancing social justice. TimeDollars reward, recognize, and honor that work.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#8FC24C]">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">The question "How can I help you?" needs to change so we ask: "Will you help someone too?" Paying it forward ensures that, together, we help each other build the world we all will live in.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#8FC24C]">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">By helping each other, we reweave communities of support, strength, and trust. Community is built by sinking roots, building trust, and creating networks.</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-l-4 border-l-[#8FC24C]">
                <CardContent className="p-6 flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">The heart and soul of democracy lies in respect for others. We strive to respect where people are in the moment, not where we hope they will be at some future point.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">
              Benefits of TimeBanking in Your Community
            </h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">Members build trust as they engage with one another, fostering community spirit and cooperation</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">Participants learn new skills while offering their expertise, promoting lifelong learning</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">Supplements community resources, providing services that may not be accessible otherwise</p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 text-sm">Strengthens social ties and networks, improving community resilience and support systems</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Start earning and spending TimeDollars today. Connect with Hong Kong's ethnic minority community through the power of time exchange.
            </p>
