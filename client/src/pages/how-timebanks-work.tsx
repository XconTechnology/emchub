        ...
        <section className="bg-gradient-to-br from-[#8FC24C] to-[#6B9A3A] text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mt-6 text-base md:text-lg opacity-90 max-w-3xl mx-auto">
              <span className="font-semibold">Beta phase:</span> We’re currently onboarding a limited number of people,
              vendors, and NGOs for beta testing. Interested in joining? Contact ILM to get beta access.
            </p>
            ...
            <div className="mt-8 flex justify-center">
              <Link href="/about-us">
                <Button
                  size="lg"
                  className="bg-white text-[#6B9A3A] hover:bg-gray-100 font-semibold px-8"
                >
                  Join Beta Testing
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              {/* ✅ UPDATED: Removed "Convert to Cash" card and adjusted to 2 columns */}
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-2 border-[#8FC24C]/30">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-600">Complete services and earn TD through events & projects</p>
                  </CardContent>
                </Card>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <span className="text-gray-700">
                          Services can vary widely—tutoring, home repairs, cooking, deliveries, and more
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#8FC24C] flex-shrink-0 mt-0.5" />
                ...
                <Card className="overflow-hidden">
                  ...
                  <CardContent className="p-6">
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#8FC24C] flex-shrink-0 mt-0.5" />
                        <span className="text-gray-700">TD is credited from the organiser after the event is completed"</span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckCircle className="w-5 h-5 text-[#8FC24C] flex-shrink-0 mt-0.5" />
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white/20 rounded-lg p-6">
                  ...
                  <p className="text-sm opacity-90 mt-2">Redemption Value</p>
                </div>

                <div className="bg-white/20 rounded-lg p-6">
                  <div className="text-4xl font-bold mb-2">Earn</div>
                  <div className="text-lg">On Completion</div>
                  <p className="text-sm opacity-90 mt-2">TD credited when events complete</p>
                </div>
